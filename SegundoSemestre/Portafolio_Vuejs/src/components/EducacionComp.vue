...
const educacion = ref([
    ...
    {fecha: '2023', title: 'Desarrolladora .Net', descripcion: 'Conocimiento de sintaxis y aplicación del lenguaje C#. Apoyado por un curso nivel 2 del profesor Maximiliano Sar Fernández (Maxiprograma), donde comienzo a ver la tecnología .Net, el paradigma de POO y estrategias de desarrollo y arquitectura. SQL y conexiones DB.', enlace:''},
    {fecha: '2022', title: 'Desarrollo Web', descripcion: 'Creación de páginas web a partir de Html y Css. También con aplicación de Bootstrap y Sass.', enlace:''},

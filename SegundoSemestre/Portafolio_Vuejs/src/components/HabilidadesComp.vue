...
import img6 from '/src/components/icons/c-sharp-svgrepo-com.svg';
...
import img12 from '/src/components/icons/github-color-svgrepo-com.svg';
import img13 from '/src/components/icons/visual-studio-svgrepo-com.svg';
import img14 from '/src/components/icons/canva-svgrepo-com.svg';
import img15 from '/src/components/icons/visual.svg';
import img16 from '/src/components/icons/sass-svgrepo-com.svg';
import img17 from '/src/components/icons/mysql.svg';
import img18 from '/src/components/icons/msql-server-svgrepo-com.svg';
...
const habilidades = ref([
    {// Se crea un objeto con id, nombre y habilidades
        id: 1, nombre: 'Lenguajes de Programación', habilidades: [
            ...
            { id: 2, nombre: 'Python', nivel: 'Inicial', icono: img2 },
            { id: 3, nombre: 'HTML/CSS', nivel: 'Avanzado', icono: img3 },
            { id: 4, nombre: 'Java', nivel: 'Inicial', icono: img4 },
            { id: 5, nombre: 'SQL', nivel: 'Inicial', icono: img5 },
            { id: 6, nombre: 'C#', nivel: 'Inicial', icono: img6 }
        ]
    },
    {
        id: 2, nombre: 'Frameworks y Librerías', habilidades: [
            { id: 1, nombre: 'Vue.js', nivel: 'Inicial', icono: img7 },
            { id: 2, nombre: 'Bootstrap', nivel: 'Intermedio', icono: img10 },
            { id: 3, nombre: 'Sass', nivel: 'Inicial', icono: img16 }
        ]
    },
    {
        id: 3, nombre: 'Herramientas y Software', habilidades: [
            { id: 1, nombre: 'Git', nivel: 'Intermedio', icono: img11 },
            { id: 2, nombre: 'GitHub', nivel: 'Intermedio', icono: img12 },
            { id: 3, nombre: 'Visual Studio', nivel: 'Inicial', icono: img13 },
            { id: 4, nombre: 'Canva', nivel: 'Avanzado', icono: img14 },
            { id: 5, nombre: 'Visual Studio Code', nivel: 'Intermedio', icono: img15 }
        ]
    },
    {
        id: 4, nombre: 'Bases de Datos', habilidades: [
            { id: 2, nombre: 'MySQL', nivel: 'Inicial', icono: img17 },
            { id: 3, nombre: 'SQL Server', nivel: 'Inicial', icono: img18 }
        ]
    },
    {
        id: 5, nombre: 'Idiomas', habilidades: [
            { id: 1, nombre: 'Español', nivel: 'Nativo', icono: img19 },
            { id: 2, nombre: 'Inglés', nivel: 'Basico (A1)', icono: img20 }
        ]
    }
]);

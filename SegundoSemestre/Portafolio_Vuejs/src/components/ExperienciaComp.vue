<script setup>
import icono1 from '/src/assets/add-circle-svgrepo-com.svg'
import icono2 from '/src/assets/bolt-circle-svgrepo-com.svg';
import icono3 from '/src/assets/danger-circle-svgrepo-com.svg';
import icono4 from '/src/assets/camera-rotate-svgrepo-com.svg';
import icono5 from '/src/assets/eye-scan-svgrepo-com.svg';
...
/*Solucione el error del nombre (con dos en lugar de uno) en la clase 6. Busque informacion en google sobre porque me marcaba un error y lo aplique*/
</script>
